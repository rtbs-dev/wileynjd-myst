...
Unofficial MystMD template for typesetting WileyNJD papers with LaTeX

![](thumbnail.png)

- Author:  LaTeX Development Team (India) (Wiley Publishing)
- Author Website:
- [Submission Guidelines](https://authorservices.wiley.com/author-resources/Journal-Authors/Prepare/new-journal-design.html)
